    ...
    <div class="navbar-brand">
        ...
        <div id="navbardefault" class="navbar-menu is-active">
            <div class="navbar-start">
                ...
                <a href="index.php?action=charityRequest" class="navbar-item">Request Resources</a>
                <a href="index.php?action=viewDonor" class="navbar-item">Suggested Donors</a>
            </div>
        <div class="navbar-end">
            <a href="index.php?action=profile" class="navbar-item">Profile</a>
        </div>
    </div>
</nav>
</body>
