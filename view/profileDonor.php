    ...
    <body>
        <div class="content">
            <main>
                ...
                echo "<table border=1>\n";
                echo "<th>Name</th><th>Phone</th><th>Hours</th>\n";
                ...
                foreach ($rows as $row) {
                    ...
                    echo "<tr><td>$name</td><td>$phone</td><td>$hours</td>";
                }
                echo "</table>\n";
                ?>
                <?php
                ...
                <table id="create">
                    <form action="index.php" method="get">
                        ...
                        <tr>
                            <td>Hours:</td>
                            <td><input type="text" name="newLink" value="<?php echo $hours ?>"></td>
                        </tr>
                        <tr>
                            <td><input type="submit" value="Update Donor"></td>
                            <td><input type="reset" value="Reset"></td>
                        </tr>
                        <td><input type="hidden" name="action" value="updateDonor"></td>
                    </form>
                </table>
                <table id="create">
                    <form action="index.php" method="get">
